...
if __name__ == '__main__':
    ...
    glave = np.load('Laboratorijske vaje/05_geometrijske_preslikave_in_poravnava_oblik/Vaja05_Geometrijske_preslikave_in_poravnava_oblik/data/glave.npy', allow_pickle=True)
    iGlava = 0 # 0 1 2 3 4 
    pts = glave[ iGlava ] 
